...
latex_documents = [
    (master_doc, "pyimzML.tex", u"pyimzML Documentation", u"Alexandrov Team", "manual"),
]
...
man_pages = [(master_doc, "pyimzml", u"pyimzML Documentation", [author], 1)]
